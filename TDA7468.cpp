...
void TDA7468::setSurround(int sur, int gain, int mix, int buf){
  switch (sur) {
  ...
  switch (mix) {
	...
	case 1: mix = 0b00000001;break;
        case 2: mix = 0b00000010;break;
	case 3: mix = 0b00000011;break;
	case 4: mix = 0b00000100;break;
	case 5: mix = 0b00000101;break;
	case 6: mix = 0b00000110;break;
	case 7: mix = 0b00000111;break;
  }
  switch (buf) {
        case 0: buf = 0b00000001;break;
	case 1: buf = 0b00000000;break;
  }
        int sum_sur = sur + gain + mix + buf;
...
void TDA7468::setTreb_Bass(int treb, int bass){
  ...
  switch (bass) {
	...
	case -12: bass = 0b00010000;break;
	case -10: bass = 0b00100000;break;
	case -8:  bass = 0b00110000;break;
        case -6:  bass = 0b01000000;break;
	case -4:  bass = 0b01010000;break;
	case -2:  bass = 0b01100000;break;
	case  0:  bass = 0b01110000;break;
        
        case 14: bass = 0b10000000;break;
	case 12: bass = 0b10010000;break;
	case 10: bass = 0b10100000;break;
	case 8:  bass = 0b10110000;break;
        case 6:  bass = 0b11000000;break;
	case 4:  bass = 0b11010000;break;
	case 2:  bass = 0b11100000;break;
  }
...
void TDA7468::setAlc(int mode, int detector, int circ, int attack, int tresh, int rez){
  ...
  switch (detector) {
        case 0: detector = 0b00000001;break;
	case 1: detector = 0b00000000;break;
  }
  switch (circ) {
        case 0: circ = 0b00000001;break;
	case 1: circ = 0b00000000;break;
  }
  switch (attack) {
        case 0: attack = 0b00000000;break;
	case 1: attack = 0b00000001;break;
        case 2: attack = 0b00000010;break;
	case 3: attack = 0b00000011;break;
  }
  switch (tresh) {
        case 0: tresh = 0b00000000;break;
	case 1: tresh = 0b00000001;break;
        case 2: tresh = 0b00000010;break;
	case 3: tresh = 0b00000011;break;
  }
  switch (rez) {
